...
export const CATEGORY_POINTS: Record<CategoryKey, number> = {
  ...
  bestDirector: 8,
  bestActor: 8,
  bestSupportingActor: 8,
  bestActress: 8,
  bestSupportingActress: 8,
  bestScreenplay: 10,
  bestPhotography: 12,
...
export const CATEGORY_FILTERS: { key: 'all' | CategoryKey; label: string }[] = [
  ...
  { key: 'bestSupportingActor', label: 'Best Supporting Actor' },
  { key: 'bestActress', label: 'Best Actress' },
  { key: 'bestSupportingActress', label: 'Best Supporting Actress' },
  ...
  { key: 'bestCostumeDesign', label: 'Best Costume Design' },
  { key: 'bestMakeupAndHairstyling', label: 'Best Makeup & Hairstyling' },
...
export const FILMS: Film[] = [
  {
    ...
    genre: 'Horror / Drama',
    nominations: 16,
    categories: ['bestPicture', 'bestDirector', 'bestActor', 'bestSupportingActor', 'bestSupportingActress', 'bestScreenplay', 'bestPhotography', 'bestOriginalSong', 'bestCostumeDesign', 'bestMakeupAndHairstyling', 'bestVisualEffects', 'bestSound'],
    points: 97,
    poster: require('@/assets/images/posters/sinners.png.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Drama',
    nominations: 13,
    categories: ['bestPicture', 'bestDirector', 'bestActor', 'bestSupportingActor', 'bestSupportingActress', 'bestScreenplay', 'bestPhotography', 'bestSound'],
    points: 65,
    poster: require('@/assets/images/posters/one-battle-after-another.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Drama / Sports',
    nominations: 8,
    categories: ['bestPicture', 'bestDirector', 'bestActor', 'bestScreenplay', 'bestPhotography', 'bestCostumeDesign'],
    points: 51,
    poster: require('@/assets/images/posters/marty-supreme.jpg'),
    synopsis:
  ...
  },
  {
    ...
    nominations: 8,
    categories: ['bestPicture', 'bestDirector', 'bestActress', 'bestScreenplay', 'bestCostumeDesign'],
    points: 39,
    poster: require('@/assets/images/posters/hamnet.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Drama',
    nominations: 9,
    categories: ['bestPicture', 'bestDirector', 'bestActress', 'bestSupportingActor', 'bestSupportingActress', 'bestScreenplay', 'bestInternationalFeature'],
    points: 55,
    poster: require('@/assets/images/posters/sentimental-value.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Horror / Drama',
    nominations: 9,
    categories: ['bestPicture', 'bestSupportingActor', 'bestScreenplay', 'bestPhotography', 'bestCostumeDesign', 'bestMakeupAndHairstyling', 'bestSound'],
    points: 57,
    poster: require('@/assets/images/posters/frankenstein.jpg'),
    synopsis:
  ...
  },
  {
    ...
    nominations: 4,
    categories: ['bestPicture', 'bestActress', 'bestScreenplay'],
    points: 23,
    poster: require('@/assets/images/posters/bugonia.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Thriller',
    nominations: 4,
    categories: ['bestPicture', 'bestActor', 'bestInternationalFeature'],
    points: 21,
    poster: require('@/assets/images/posters/the-secret-agent.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Action / Sports',
    nominations: 4,
    categories: ['bestPicture', 'bestVisualEffects', 'bestSound'],
    points: 21,
    poster: require('@/assets/images/posters/f1.jpg'),
    synopsis:
  ...
  },
  {
    ...
    genre: 'Drama / Western',
    nominations: 4,
    categories: ['bestPicture', 'bestScreenplay', 'bestPhotography', 'bestOriginalSong'],
    points: 33,
    poster: require('@/assets/images/posters/train-dreams.jpg'),
    synopsis:
  ...
  },
  {
    ...
    points: 18,
    poster: require('@/assets/images/posters/blue-moon.jpg'),
    synopsis:
  ...
  },
  {
    ...
    nominations: 2,
    categories: ['bestScreenplay', 'bestInternationalFeature'],
    points: 18,
    poster: require('@/assets/images/posters/it-was-just-an-accident.jpg'),
    synopsis:
  ...
  },
  {
    ...
    nominations: 1,
    categories: ['bestAnimatedFeature'],
    points: 8,
  ...
  },
  {
    ...
    nominations: 2,
    categories: ['bestCostumeDesign', 'bestVisualEffects'],
    points: 18,
  ...
  },
  {
    ...
    genre: 'Drama',
    nominations: 1,
    categories: ['bestMakeupAndHairstyling'],
    points: 8,
  ...
  },
  {
    ...
    nominations: 2,
    categories: ['bestAnimatedFeature', 'bestOriginalSong'],
    points: 14,
  ...
  },
  {
    ...
    nominations: 2,
    categories: ['bestInternationalFeature', 'bestSound'],
    points: 14,
  ...
  },
  {
    ...
    genre: 'Drama',
    nominations: 1,
    categories: ['bestInternationalFeature'],
    points: 8,
  ...
  },
  {
    ...
    nominations: 1,
    categories: ['bestSupportingActress'],
    points: 8,
